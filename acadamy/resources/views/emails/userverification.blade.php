  ...
  <tr>
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        ...
        <tr> <td class="header-lg" style="vertical-align: middle;">
                      <a href=""><img height="60" src="{{ URL::asset('dist/img/oclogo.png') }}" alt="Oman Cricket"></a>
                    </td></tr>
          <tr>
            <td class="header-lg"> <h3 style="text-align:left">Hi {{$name}} , </h3></td>
          </tr>
          <tr>
            <td class="header-lg">
          ...
          <tr>
            <td class="free-text">              
              Thank you for signing up with Oman Cricket Academy!. Please confirm your email by clicking the link below.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a class="button-mobile" href="{{ URL::to('api/v1/user/verify/' . $verificationCode) }}"
